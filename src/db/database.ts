...
class ChikitsaDatabase {
  ...
  private hospitals: Hospital[] = [
    ...
    },
    {
      ...
      acceptedGovSchemes: ['100% Free Public Care', 'Ayushman Bharat PM-JAY', 'MJPJAY Maharashtra', 'National Health Mission'],
      emergency24x7: true,
      contactNumber: '+91 22 2410 7000',
      mapsCoord: { lat: 19.0028, lng: 72.8427 },
      opdDepartments: ['Cardiovascular Thoracic Surgery', 'Cardiology', 'Neurosurgery', 'General Surgery', 'Gastroenterology', 'Nephrology'],
      bedTelemetry: {
        icuTotal: 92,
        icuAvailable: 18,
        ventilatorTotal: 48,
      ...
      bloodBankStock: [
        { group: 'A+', units: 68, isCriticallyLow: false },
        { group: 'A-', units: 14, isCriticallyLow: false },
        { group: 'B+', units: 82, isCriticallyLow: false },
        { group: 'B-', units: 12, isCriticallyLow: false },
        { group: 'AB+', units: 31, isCriticallyLow: false },
        { group: 'AB-', units: 8, isCriticallyLow: false },
        { group: 'O+', units: 104, isCriticallyLow: false },
        { group: 'O-', units: 16, isCriticallyLow: false }
      ],
      costProfile: {
        tier: 'FREE_PUBLIC',
    ...
    },
    {
      ...
      acceptedGovSchemes: ['Ayushman Bharat PM-JAY', 'MJPJAY Maharashtra', 'Tata Trusts Empanelled', 'CGHS', 'ECHS', 'Corporate Cashless'],
      emergency24x7: true,
      contactNumber: '+91 20 6645 5100',
      mapsCoord: { lat: 18.5308, lng: 73.8775 },
      opdDepartments: ['Interventional Cardiology', 'Medical Oncology', 'Radiation Oncology', 'Neurology', 'Organ Transplant', 'Robotic Surgery'],
      bedTelemetry: {
        icuTotal: 65,
        icuAvailable: 16,
        ventilatorTotal: 34,
    ...
    },
    {
      ...
      rating: 4.8,
      chikitsaCareScore: 95,
      acceptedGovSchemes: ['MJPJAY Maharashtra', 'Ayushman Bharat PM-JAY', 'Tata Trusts Empanelled', 'Subsidized Trust Grants'],
      emergency24x7: true,
      contactNumber: '+91 20 4015 1000',
      mapsCoord: { lat: 18.5020, lng: 73.8315 },
      opdDepartments: ['Cardiology', 'Pediatric Surgery', 'Joint Replacement & Ortho', 'Gastroenterology', 'General Medicine', 'Pulmonology'],
      bedTelemetry: {
        icuTotal: 48,
        icuAvailable: 11,
        ventilatorTotal: 24,
    ...
    },
    {
      ...
      acceptedGovSchemes: ['100% Free Public Care', 'Ayushman Bharat PM-JAY', 'Tata Trusts Empanelled', 'MJPJAY Maharashtra', 'PMNRF'],
      emergency24x7: true,
      contactNumber: '+91 22 2417 7000',
      mapsCoord: { lat: 19.0055, lng: 72.8431 },
      opdDepartments: ['Medical Oncology', 'Surgical Oncology', 'Radiation Oncology', 'Bone Marrow Transplant', 'Palliative Care', 'Hematology'],
      bedTelemetry: {
        icuTotal: 70,
        icuAvailable: 15,
        ventilatorTotal: 38,
    ...
    },
    {
      ...
      opdDepartments: ['Emergency Trauma', 'General Medicine', 'Ophthalmology', 'General Surgery', 'Plastic Surgery', 'Dermatology'],
      bedTelemetry: {
        icuTotal: 50,
        icuAvailable: 12,
        ventilatorTotal: 26,
      ...
      bloodBankStock: [
        ...
        { group: 'B+', units: 50, isCriticallyLow: false },
        { group: 'B-', units: 8, isCriticallyLow: false },
        { group: 'AB+', units: 20, isCriticallyLow: false },
        { group: 'AB-', units: 5, isCriticallyLow: true },
        { group: 'O+', units: 66, isCriticallyLow: false },
    ...
    },
    {
      ...
      acceptedGovSchemes: ['Ayushman Bharat PM-JAY', 'MJPJAY Maharashtra', 'Charitable Trust Reserved Quota'],
      emergency24x7: true,
      contactNumber: '+91 22 2675 1000',
      mapsCoord: { lat: 19.0514, lng: 72.8295 },
      opdDepartments: ['Cardiology', 'Neurosurgery', 'Nephrology & Dialysis', 'Critical Care', 'Endocrinology', 'Gastroenterology'],
      bedTelemetry: {
        icuTotal: 44,
        icuAvailable: 10,
        ventilatorTotal: 22,
      ...
      costProfile: {
        tier: 'PMJAY_CASHLESS_MODERATE',
        tierLabel: 'Charitable Trust with PM-JAY Empanelled Beds',
        opdConsultFee: 750,
        pmjayCashlessCoverage: true,
        estOutOfPocketPercent: 14,
        costScore: 82,
        approxTreatmentRange: 'PM-JAY 100% Cashless / Trust Concessions'
      }
    },
    {
      id: 'HOSP-MH-08',
      ...
      rating: 4.9,
      chikitsaCareScore: 98,
      acceptedGovSchemes: ['100% Free Public Care', 'Ayushman Bharat PM-JAY', 'Rashtriya Arogya Nidhi'],
      emergency24x7: true,
      contactNumber: '+91 712 281 5000',
      mapsCoord: { lat: 21.0664, lng: 79.0375 },
      opdDepartments: ['Trauma & Emergency', 'Cardiology', 'Pulmonary Medicine', 'Neurology', 'Pediatrics', 'Pathology'],
      bedTelemetry: {
        icuTotal: 80,
        icuAvailable: 22,
        ventilatorTotal: 40,
      ...
      bloodBankStock: [
        ...
        { group: 'AB-', units: 6, isCriticallyLow: false },
        { group: 'O+', units: 82, isCriticallyLow: false },
        { group: 'O-', units: 13, isCriticallyLow: false }
      ],
      costProfile: {
        tier: 'FREE_PUBLIC',
        tierLabel: '100% Free Public Apex Central Care',
        opdConsultFee: 10,
        pmjayCashlessCoverage: true,
        estOutOfPocketPercent: 0,
        costScore: 99,
  ...
  private crowdfundingCampaign: CrowdfundingCampaign = {
    ...
    hospitalName: 'Ruby Hall Pediatric Cardiac Center, Pune',
    targetAmount: 350000,
    raisedAmount: 268400,
    donorCount: 142,
  ...
  private csrPrograms: CSRCareProgram[] = [
    {
      ...
      empanelledHospitals: ['Tata Memorial Hospital, Mumbai', 'Sassoon General Hospital, Pune', 'Ruby Hall Clinic, Pune'],
    ...
    },
    {
      ...
      empanelledHospitals: ['Sir H.N. Reliance Foundation Hospital, Mumbai', 'Ruby Hall Clinic, Pune', 'Deenanath Mangeshkar Hospital, Pune'],
    ...
    },
    {
      ...
      empanelledHospitals: ['KEM Hospital, Mumbai', 'Sassoon General Hospital, Pune', 'Lilavati Hospital, Mumbai'],
    ...
    },
    {
      ...
      empanelledHospitals: ['Sir J.J. Hospital, Mumbai', 'Sassoon General Hospital, Pune', 'AIIMS Nagpur'],
    ...
    },
    {
      ...
      empanelledHospitals: ['Tata Memorial Hospital, Mumbai', 'KEM Hospital, Mumbai', 'AIIMS Nagpur'],
  ...
  registerDoctor(form: DoctorRegistrationForm): User {
    ...
    const newDoctorProfile: DoctorProfile = {
      ...
      hospitalAffiliation: form.hospitalAffiliation || 'Sassoon General Hospital & B.J. Medical College, Pune',
